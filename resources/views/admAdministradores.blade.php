...
<body>
    ...
    <div class="contenedor">
        ...
        <div class="tabla" onclick="location.href='{{route('administradores.agregar')}}';" style="cursor: pointer;">
            <img src="{{ asset('img/admin.jpeg') }}" alt="imagen" class="imagen">
            <h2>Agregar Usuario</h2>
        </div>

        <div class="tabla" onclick="location.href='{{route('administradores.eliminar')}}';" style="cursor: pointer;">
            <img src="{{ asset('img/admin.jpeg') }}" alt="imagen" class="imagen">
            <h2>Eliminar Usuario</h2>
        </div>

        <div class="tabla" onclick="location.href='{{route('administradores.lista')}}';" style="cursor: pointer;">
            <img src="{{ asset('img/admin.jpeg') }}" alt="imagen" class="imagen">
