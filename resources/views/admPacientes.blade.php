...
<body>
    ...
    <div class="contenedor">
        ...
        <div class="tabla" onclick="location.href='{{route('pacientes.crear')}}';" style="cursor: pointer;">
            <img src="{{ asset('img/paciente.jpeg') }}" alt="imagen" class="imagen">
            <h2>Crear Expediente</h2>
        </div>

        <div class="tabla" onclick="location.href='{{route('pacientes.historial')}}';" style="cursor: pointer;">
            <img src="{{ asset('img/paciente.jpeg') }}" alt="imagen" class="imagen">
            <h2>Historial Clinico</h2>
        </div>

        <div class="tabla" onclick="location.href='{{route('pacientes.citas')}}';" style="cursor: pointer;">
            <img src="{{ asset('img/paciente.jpeg') }}" alt="imagen" class="imagen">
            <h2>Expedientes</h2>
        </div>
