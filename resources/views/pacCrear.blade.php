...
<head>
    ...
    <style>
        ...
        .fondo {
            width: 50%;
            height: 100vh;
            background-image: url('{{ asset('img/hospital11.jpg') }}');
...
<body>
    ...
    <div class="contenedor">
        ...
        <div class="encabezado">
            <img src="{{ asset('img/paciente.jpeg') }}" alt="icono" class="icono">
            ...
            <div class="form-container">
                <form action="{{ route('paciente.salvar') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input class="caja" type="text" id="apellido" name="apellido" required>
                    </div>
                    <div class="form-group">
                        <label for="fechanacimiento">Fecha de nacimiento:</label>
                        <input class="caja" type="text" id="fechanacimiento" name="fechanacimiento" required>
                    </div>
                    <div class="form-group">
                        <label for="direccion">Dirección:</label>
                        <input class="caja" type="text" id="direccion" name="direccion" required>
                    </div>
                    <div class="form-group">
                        <label for="telefono">Teléfono:</label>
                        <input class="caja" type="text" id="telefono" name="telefono" required>
                    </div>
                    <div class="form-group">
        ...
        <button class="boton" onclick="window.location.href='{{route('pacientes')}}'">Retroceder</button>
