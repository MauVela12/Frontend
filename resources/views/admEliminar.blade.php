    ...
    <div class="contenedor">
        ...
        <div class="formulario">
            ...
            <form action="{{ route('usuarios.destroy') }}" method="POST">
                @csrf
                @method('DELETE') <!-- Esto convierte la solicitud en una de tipo DELETE -->
                
                <label for="idusuario">ID Usuario:</label>
                <input class="caja" type="text" name="idusuario" id="idusuario" required>
            
                <button class="bot" type="submit">Eliminar Usuario</button>
            </form>
