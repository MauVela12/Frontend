...
<body>
    ...
    <div class="contenedor">
        ...
        <div class="encabezado">
            ...
            <h3>Administrar Farmacia</h3>
        </div>

        <div class="tabla" onclick="location.href='{{route('farmacia.lista')}}';" style="cursor: pointer;">
            <img src="{{ asset('img/medic.jpeg') }}" alt="imagen" class="imagen">
            <h2>Lista de Medicamentos</h2>
        </div>

        <div class="tabla" onclick="location.href='{{route('farmacia.cantidad')}}';" style="cursor: pointer;">
            <img src="{{ asset('img/medic.jpeg') }}" alt="imagen" class="imagen">
            <h2>Cantidad Medicamento</h2>
        </div>

        <div class="tabla" onclick="location.href='{{route('farmacia.crear')}}';" style="cursor: pointer;">
            <img src="{{ asset('img/medic.jpeg') }}" alt="imagen" class="imagen">
