    ...
    <div class="contenedor">
        ...
        <div class="formulario">
            ...
            <div class="form-container">
                <form action="{{ route('farmacia.salvar') }}" method="POST">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input class="caja" type="text" id="descripcion" name="descripcion" required>
                    </div>
                    <div class="form-group">
                        <label for="cantidad">Cantidad:</label>
                        <input class="caja" type="text" id="cantidad" name="cantidad" required>
                    </div>
                    <div class="form-group">
                        <label for="fechacaducidad">Fecha Caducidad:</label>
                        <input class="caja" type="text" id="fechacaducidad" name="fechacaducidad" required>
                    </div>
