...
<head>
    ...
    <style>
        ...
        .fondo {
            width: 50%;
            height: 100vh;
            background-image: url('{{ asset('img/hospital18.jpg') }}');
...
<body>
    ...
    <div class="contenedor">
        ...
        <div class="encabezado">
            <img src="{{ asset('img/cita.jpeg') }}" alt="icono" class="icono">
            <h3>Estados de Cita</h3>
        </div>



        <button class="boton" onclick="window.location.href='{{route('empleado.inicio')}}'">Retroceder</button>
